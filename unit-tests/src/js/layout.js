...
function linkModel(fieldtype, projectName, tempArrayFnc, modelNameFnc) {
    ...
    // $(event.target).closest(".dropped-content").addClass("dropped-content-active"); //testing purpose
    ...
    tempArrayFnc("tempArray"); //testing purpose
    modelNameFnc("modelName"); //testing purpose
...
function addPages(projectName, currentModel, pagename, successFnc) {
    ...
    successFnc("msg.Pages"); //testing purpose
...
function removePage(pageName, pageID, projectName, successFnc) {
    ...
    successFnc("msg.Status"); // testing purpose
...
function loadPageFields(projectName, selectedPageID, dropArray) {
    ...
    dropArray("tempArray"); //testing purpose
...
function tabFirstLoad(droppedList, newPos) {
    ...
    newPos("droppedList"); //teting purpose
}
...
function previewTab() {
    ...
    // var dropPreviewScrollHeight = ($('.drop-preview')[0].scrollHeight) + 100; //testing purpose
    // $('.drop-preview').height(dropPreviewScrollHeight); //testing purpose
