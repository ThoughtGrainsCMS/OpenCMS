...
///   File Name   :   addEntryController.js                                                                          ///

///   Description :   addEntryController.js                                                                          ///

///                                                                                                                  ///

///   Date :   26/06/2016                                          Created By  :   Thoughtgrains Solutions           ///

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

cmsApp.controller("addEntryController", ['$scope', function ($scope) {
    ...
    $scope.submitEntry = function () {
        ...
        $("#Formfields").find(".form-group").each(function (n, a) {
            ...
            if ($(this).children().length > 2) {
                ...
                if (inputChildren.is(":file")) {
                    if (inputChildren.val() !== "") {
                        filefields.push(inputChildren.attr("name"));
                        fieldvalues.push({FieldVals: inputChildren[0].files[0].name});
                    }
                    else {
                        fieldvalues.push({FieldVals: "No file selected"});
                    }
                } else {
